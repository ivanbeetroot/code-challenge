...
export class Init1734105794572 implements MigrationInterface {
  name = 'Init1734105794572';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "country" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "flag" jsonb, CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_2c5aa339240c0c3ae97fcc9dc4" ON "country" ("name") `,
    );
    await queryRunner.query(
      `ALTER TABLE "country_translation" ADD CONSTRAINT "FK_0ec3eaa449020c069854451caaa" FOREIGN KEY ("countryId") REFERENCES "country"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
